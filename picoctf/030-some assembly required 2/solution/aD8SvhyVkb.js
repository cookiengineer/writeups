...
function initActiveSegments() {
	base64DecodeToExistingUint8Array(bufferView, 1024, "eGFrZ0tcTnNsPDg/bm1pOjxpOzBqOTo7P25tOGk9MD8/Oj1uam49OXUAAA==");
}
...
function asmFunc(env) {
	...
	return {
		...
		"input": global$1,
		"copy_char": $3,
		"__dso_handle": global$2,
		"__data_end": global$3,
		"__global_base": global$4,
		"__heap_base": global$5,
		"__memory_base": global$6,
		"__table_base": global$7
	};
}
...
var strcmp = retasmFunc.strcmp;
var check_flag = retasmFunc.check_flag;
var copy_char = retasmFunc.copy_char;


initActiveSegments();


console.log(retasmFunc);

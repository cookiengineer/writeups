...
static void w2c___wasm_call_ctors(Z_Z5AoRd23o0wd_instance_t*);
static u32 w2c_strcmp(Z_Z5AoRd23o0wd_instance_t*, u32, u32);
static u32 w2c_check_flag(Z_Z5AoRd23o0wd_instance_t*);
static void w2c_copy_char(Z_Z5AoRd23o0wd_instance_t*, u32, u32);

static void init_globals(Z_Z5AoRd23o0wd_instance_t* instance) {
...
static void init_memories(Z_Z5AoRd23o0wd_instance_t* instance) {
  wasm_rt_allocate_memory(&instance->w2c_memory, 2, 65536);
  LOAD_DATA(instance->w2c_memory, 1024u, data_segment_data_w2c_d0, 43);
}

static void init_data_instances(Z_Z5AoRd23o0wd_instance_t *instance) {
}

static void init_tables(Z_Z5AoRd23o0wd_instance_t* instance) {
  wasm_rt_allocate_funcref_table(&instance->w2c_T0, 1, 1);
}

static void w2c___wasm_call_ctors(Z_Z5AoRd23o0wd_instance_t* instance) {
  FUNC_PROLOGUE;
  FUNC_EPILOGUE;
}

static u32 w2c_strcmp(Z_Z5AoRd23o0wd_instance_t* instance, u32 w2c_p0, u32 w2c_p1) {
...
static u32 w2c_check_flag(Z_Z5AoRd23o0wd_instance_t* instance) {
...
static void w2c_copy_char(Z_Z5AoRd23o0wd_instance_t* instance, u32 w2c_p0, u32 w2c_p1) {
...
void Z_Z5AoRd23o0wdZ___wasm_call_ctors(Z_Z5AoRd23o0wd_instance_t* instance) {
  return w2c___wasm_call_ctors(instance);
}

/* export: 'strcmp' */
u32 Z_Z5AoRd23o0wdZ_strcmp(Z_Z5AoRd23o0wd_instance_t* instance, u32 w2c_p0, u32 w2c_p1) {
  return w2c_strcmp(instance, w2c_p0, w2c_p1);
}

/* export: 'check_flag' */
u32 Z_Z5AoRd23o0wdZ_check_flag(Z_Z5AoRd23o0wd_instance_t* instance) {
...
/* export: 'copy_char' */
void Z_Z5AoRd23o0wdZ_copy_char(Z_Z5AoRd23o0wd_instance_t* instance, u32 w2c_p0, u32 w2c_p1) {
...
void Z_Z5AoRd23o0wd_instantiate(Z_Z5AoRd23o0wd_instance_t* instance) {
  assert(wasm_rt_is_initialized());
...
void Z_Z5AoRd23o0wd_free(Z_Z5AoRd23o0wd_instance_t* instance) {
